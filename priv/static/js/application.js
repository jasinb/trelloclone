...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = (0, _store2.default)(_reactRouter2.default);
	var target = document.getElementById('main_container');
	var node = _react2.default.createElement(_root2.default, { routerHistory: _reactRouter2.default, store: store });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function configureStore(browserHistory) {
	    var reduxRouterMiddleware = (0, _reactRouterRedux2.default)(browserHistory);
	    var createStoreWithMiddleware = applyMiddlware(reduxRouterMiddleware, _reduxThunk2.default, loggerMiddleware)(_redux.createStore);

	    return createStoreMiddleware(_reducers2.default);
	}
